let tareas = [
  [1, "Levantarse", "08:00", "10:00", "Completada","Alta"],
  [2, "Comer", "10:00", "12:00", "En Curso","Baja"],
  [3, "Hacer deberes", "12:00", "14:00", "Nueva","Media"],
  [4, "Ejercicio", "12:20", "14:00", "Completada","Baja"],
];
...
function editarTarea() {
  ...
  document.getElementById("editPrioridad").value = tareaEditando[5];
}
